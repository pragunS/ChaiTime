...
<br>
<br>
 <p style="color:white;" class="sansserif"><img src="images/jojo rabbit.jpg"style="width:300px;height:300px;margin:15px 200px">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<i class="fa fa-imdb" style="font-size:24px;color: red"></i>&emsp;8.0/10 | Hollywood | English
  <br>
  <h1 style="color:white"; class="sansserif" ><b>&emsp;&emsp;Jojo Rabbit (2019)</b></h1><br>
  <p style="color:white;" class="sansserif">A young boy in Hitler's army finds out his mother is hiding a Jewish girl in their home.</p>
 </p>
 <br>
 <p  style="color:white;" class="sansserif">&emsp;&emsp;&emsp;&emsp;<b>Directors :</b>    Taika Waititi | <b>Cast :</b> Roman Griffin Davis, Thomasin McKenzie, Scarlett Johansson</p>
 <br>
...
<div class="row">
  <div class="column">
    <img src="images/jojorabbit1.jpg" style="width:390px; height:200px"  onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="images/download (6).jfif"style="width:390px; height:200px"  onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="images/1118full-jojo-rabbit-screenshot.jpg"style="width:390px; height:200px" onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="images/1118full-jojo-rabbit-screenshot (1).jpg" style="width:390px; height:200px" onclick="myFunction(this);">
  </div>
</div>
