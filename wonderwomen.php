...
<br>
<br>
 <p style="color:white;" class="sansserif"><img src="images/wonderwomen.jpg"style="width:300px;height:300px;margin:15px 200px">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<i class="fa fa-imdb" style="font-size:24px;color: red"></i>&emsp;8.0/10 | Hollywood | English
  <br>
  <h1 style="color:white"; class="sansserif" ><b>&emsp;&emsp;Wonder Woman 1984 (2020)</b></h1><br>
  <p style="color:white;" class="sansserif">A sequel to the 2017 superhero film 'Wonder Woman.'</p>
 </p>
 <br>
 <p  style="color:white;" class="sansserif">&emsp;&emsp;&emsp;&emsp;<b>Directors :</b>     Patty Jenkins | <b>Cast :</b> Pedro Pascal, Gal Gadot, Connie Nielsen</p>
 <br>
...
<div class="row">
  <div class="column">
    <img src="images/5YVV62RI5NGF5PDBMMV6KVGNXU.jpg" style="width:390px; height:200px"  onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="images/images (1).jfif"style="width:390px; height:200px"  onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="images/wonder-woman-1984-trailer-golden-armor.jpg"style="width:390px; height:200px" onclick="myFunction(this);">
  </div>
  <div class="column">
    <img src="images/z-26-1024x576.jpg" style="width:390px; height:200px" onclick="myFunction(this);">
  </div>
</div>
